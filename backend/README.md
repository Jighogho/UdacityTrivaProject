...
You don't require request arguments 

Returns a jsonify object containing key-value pairs of categories, questions and total number of question.
...
T
akes in an integer argument, category
...
Takes a form submission in json from the client, e.g { 'question': 'question', 'answer': 'answer', 'difficulty': 2, 'category': 4 }
...
Fetches every question and checks to see if any has been previously asked. If there are previous questions, the questions will be filtered out of the fetched questions.
